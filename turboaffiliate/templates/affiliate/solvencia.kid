...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:py="http://purl.org/kid/ns#">
	...
	<body>
		...
		<span py:content="dia.strftime('%A, %d de %B de %Y')" />.</p>
		<br />
		<br />
		<span class="firma enfasis">PROF. JAIME RODRIGUEZ</span>
		<span class="firma enfasis">PRESIDENTE</span>
		<span class="firma enfasis">COPEMH</span>
	</body>
</html>
