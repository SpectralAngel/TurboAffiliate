...
<body>
  ...
  <ul>
    ...
    <li><strong>Fecha de Otorgamiento:</strong> ${loan.startDate}</li>
    <li><strong>Monto Original:</strong> ${locale.currency(loan.capital, True, True)}</li>
  </ul>
  <table class="striped">
  ...
  <table class="striped pay" py:if="len(loan.pays) != 0">
