...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:py="http://purl.org/kid/ns#">
	...
	<body>
		<h1><center>Pagar&eacute; por L. ${locale.format('%s', loan.capital, True)}</center></h1>
		<p>
			Yo, <strong>${loan.affiliate.firstName} ${loan.affiliate.lastName}</strong>,
			pagar&eacute; al Colegio de Profesores de Educaci&oacute;n de
			Honduras. (COPEMH). La cantidad de <strong>${loan.letters} Lempiras</strong>
			(L. ${loan.capital}) que en esta fecha recibo a mi entera
			satisfacci&oacute;n y en calidad de pr&eacute;stamo. Esta
			obligaci&oacute;n devengar&aacute; intereses a la tasa de
		...
		<p>
			...
			el d&iacute;a ${loan.startDate.day, '/', loan.startDate.month, '/',  loan.startDate.year}
		</p>
		<p class="center">Firma del Suscriptor</p>
		<p>
			Nombre del Afiliado: <strong>${loan.affiliate.firstName} ${loan.affiliate.lastName}</strong>
			<br />
			Tarjeta de <strong>Identidad: ${loan.affiliate.cardID}</strong>
		</p>
